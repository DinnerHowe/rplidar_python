  ...
  if self.header_check()==measurement:
   while not rospy.is_shutdown():
    ...
    # rplidar_data
     ...
     self.rplidar_data.point=self.coordinates

     print 'angle length:',len(self.rplidar_data.angle),'distance length:',len(self.rplidar_data.distance),'point length:',len(self.rplidar_data.point),self.rplidar_data.frame,'\n'
